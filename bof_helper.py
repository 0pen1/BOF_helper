...
def find_library(method):
        library = 0
        try:
            ms_uri="https://learn.microsoft.com/api/search?search={}&scope=Desktop&locale=en-us&scoringprofile=semantic-captions&facet=category&facet=products&%24filter=(scopes%2Fany(t%3A%20t%20eq%20%27Desktop%27))&%24top=1&expandScope=true".format(method)
